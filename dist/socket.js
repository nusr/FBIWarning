...
const ip_address_1 = __importDefault(require("ip-address"));
const EventEmitter = events_1.default.EventEmitter;
const Address6 = ip_address_1.default.Address6;
class Socks5ClientSocket extends EventEmitter {
    constructor(options) {
        super();
        let self = this;
        self.socket = new net_1.default.Socket();
    ...
    ;
        ...
        let ret = this.socket.end(data, encoding);
    ...
    ;
    destroySoon() {
        let ret = this.socket.destroySoon();
...
exports.default = Socks5ClientSocket;
function authenticateWithSocks(client, cb) {
    let authMethods, buffer;
...
function connectSocksToHost(client, host, port, cb) {
    ...
    switch (net_1.default.isIP(host)) {
...
function parseString(string, request) {
    let buffer = new Buffer(string), i, l = buffer.length;
...
function parseIPv6(host, request) {
    let i, b1, b2, part1, part2, address, groups;
