...
class ParseCategory extends base_1.BaseSpider {
    ...
    recursionExecutive() {
        return __awaiter(this, void 0, void 0, function* () {
            let $ = yield this.requestPage(config_1.default.baseUrl);
            if ($) {
                this.parseHtml($);
            }
            else {
    ...
    requestFailure() {
        let text = `
    ------------------------------------------------------------\n
    ------------代理${socks_json_1.default.host} : ${socks_json_1.default.port}不可用!!!-----------------\n
    ------------代理配置错误，一定要配置代理!!!-----------------\n
    -----------------------------------------------------------`;
        console.log(text);
    }
    ...
    parseHtml($) {
        ...
        async_1.default.mapLimit(links, config_1.default.connectTasks, (url) => __awaiter(this, void 0, void 0, function* () {
            return this.requestPage(config_1.default.baseUrl + url);
        }), (err, results) => {
            if (err) {
                base_1.log(err.toString());
            }
